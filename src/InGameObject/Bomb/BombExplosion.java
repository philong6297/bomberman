...
public class BombExplosion extends TileAbstract {

	protected boolean _last = false;
	protected Board _board;
	protected Sprite _sprite1, _sprite2;
	
	public BombExplosion(int x, int y, int direction, boolean last, Board board) {
		_x = x;
		_y = y;
		_last = last;
		_board = board;
	...
	public boolean collide(TileAbstract e) {
		...
		if(e instanceof CharacterAbstract) {
			((CharacterAbstract)e).kill();
		}
